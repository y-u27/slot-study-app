...
function getStage(rate: number): StageStyle {
  ...
  if (rate < 80)
    return {
      background:
        "linear-gradient(170deg, #1a1040 0%, #0d0820 60%, #120830 100%)",
      borderWidth: 3,
      borderStyle: "solid",
      borderColor: "#3b82f6",
  ...
  return {
    background:
      "linear-gradient(170deg, #2a1060 0%, #1a0840 50%, #200a30 100%)",
    borderWidth: 3,
    borderStyle: "solid",
    borderColor: "#d4a820",
  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          "filter 0.8s ease, box-shadow 0.8s ease, border-color 0.8s ease",
      }}
    >
      {/* ── Header ── */}
      <div
