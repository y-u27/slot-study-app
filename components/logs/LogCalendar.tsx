    ...
    <div className="flex flex-col h-full select-none">
          ...
          return (
            ...
            >
              ...
              <span className="h-1.5 mt-0.5 flex items-center justify-center">
                {dotColor && (
                  <span className={`w-1 h-1 rounded-full ${dotColor} ${isSel ? 'opacity-80' : ''}`} />
                )}
              </span>
            </button>
          )
      ...
      <div className="border-t border-gray-100 px-2 py-2 flex flex-col gap-1">
        <div className="flex items-center gap-1.5 text-[9px] text-gray-400">
          <span className="w-1.5 h-1.5 rounded-full bg-green-400 inline-block" />全達成
        </div>
        <div className="flex items-center gap-1.5 text-[9px] text-gray-400">
          <span className="w-1.5 h-1.5 rounded-full bg-amber-400 inline-block" />一部達成
        </div>
        <div className="flex items-center gap-1.5 text-[9px] text-gray-400">
          <span className="w-1.5 h-1.5 rounded-full bg-gray-300 inline-block" />未達成
        </div>
      </div>
    </div>
  )
